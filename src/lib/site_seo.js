 ...
 */
export const site_public_origin_default = 'https://michela-model-portfolio.vercel.app';
/** OG share image — file at static/preview.jpg */
export const share_image_path = '/preview.jpg';
/** Full URL for og:image / Twitter (always https + host + path) */
export const share_image_absolute_url = `${site_public_origin_default.replace(/\/$/, '')}${share_image_path}`;
